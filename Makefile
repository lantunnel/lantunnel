...
deploy:  ## Print the minimal static V2 provisioning and startup workflow
	@echo ""
	@echo "  1) Install the gateway binary on the target host:"
	@echo ""
	@echo "     install -m 0755 lantunnel-gateway-$(VERSION)-<triple> ./lantunnel-gateway"
	@echo ""
	@echo "  2) Start the gateway (public QUIC listener):"
	@echo ""
	@echo "     ./lantunnel-gateway --config configs/gateway.yaml"
	@echo ""
	@echo "  3) Generate a Tunnel/Scope and one or more signed Peer profiles:"
	@echo ""
	@echo "     ./lantunnel-admin init-tunnel --gateway-transport quic --gateway-host <host> --gateway-port 8443"
	@echo "     ./lantunnel-admin add-peer --tunnel <Tunnel>.tunnel"
	@echo ""
	@echo "  4) Install the public Scope in the Gateway scopes.d directory, import"
	@echo "     the .peer on each Client, then connect by Tunnel ID:"
	@echo ""
